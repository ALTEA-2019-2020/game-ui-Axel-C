package com.miage.altea.tp.repository;

import com.miage.altea.game_ui.repository.TranslationRepository;
import com.miage.altea.game_ui.repository.TranslationRepositoryImpl;
...
class TranslationRepositoryImplTest {
    ...
    void applicationContext_shouldLoadPokemonRepository(){
        var context = new AnnotationConfigApplicationContext("com.miage.altea.game_ui.repository");
